...
|-----|-------------|----------|
| `Exception in thread "streaming-start" java.lang.UnsatisfiedLinkError: 'boolean org.apache.hadoop.io.nativeio.NativeIO$Windows.access0(java.lang.String, int)'` | Thiếu hadoop.dll trong C:\hadoop\bin và C:\Windows\System32 | Tải và đặt vào 2 folder. Link tải: https://github.com/steveloughran/winutils. Cấu hình biến môi trường nếu chưa có: ```bash set HADOOP_HOME=c:/hadoop  set PATH=%PATH%;%HADOOP_HOME%/bin; ```|
